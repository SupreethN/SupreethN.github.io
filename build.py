...
def get_personal_data():
    ...
    bio_text = f"""
                <p>
                    I am a Research Scientist at Adobe Firefly working on Generative AI. Specifically, I work on foundational image and video generative models.
                </p>
                <p>
                    Prior to joining Adobe, I was a PhD student in <a href="https://www3.cs.stonybrook.edu/~cvl/" target="_blank">CVLab</a> at <a href="https://www.cs.stonybrook.edu" target="_blank">Stony Brook University (New York, US)</a>, working on Computer Vision and Machine Learning. I am fortunate to have been supervised by <a href="https://www3.cs.stonybrook.edu/~minhhoai/" target="_blank">Prof. Minh Hoai</a>.
                </p>
                <p>
                ...
                <div class="row" style="margin-top: 1em;">
                    <div class="col-sm-12" style="">
                        ...
                        <ul style="line-height:1.5;">
                            <li>[Feb. 2024]</span> Our work on generating plausible hands in diffusion-based text-to-image models is accepted to CVPR, 2024. </li>
                            <li>[Feb. 2024]</span> Our work on segmenting and tracking hand-held objects is accepted to CVPR, 2024. </li>                         
