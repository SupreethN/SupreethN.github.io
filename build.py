...
def get_personal_data():
    ...
    bio_text = f"""
                <p>
                    I am a Research Scientist at Luma AI working on multimodal AI foundational models.
                </p>
                <p>
                    Prior to joining Luma AI, I was a Research Scientist at Adobe working on generative models for images. I was a PhD student in <a href="https://www3.cs.stonybrook.edu/~cvl/" target="_blank">CVLab</a> at <a href="https://www.cs.stonybrook.edu" target="_blank">Stony Brook University (New York, US)</a>, working on Computer Vision and Machine Learning. I am fortunate to have been supervised by <a href="https://www3.cs.stonybrook.edu/~minhhoai/" target="_blank">Prof. Minh Hoai</a>.
                </p>
                <p>
                    <a href="mailto:supreeth.narasimhaswamy@gmail.com" style="margin-right: 5px"><i class="far fa-envelope-open fa-lg"></i> Mail</a>
                    <a href="https://scholar.google.com/citations?user=m4VjBbsAAAAJ&hl=en" target="_blank" style="margin-right: 5px"><i class="fa-solid fa-book"></i> Scholar</a>
            ...
            <div class="col-md-10">
                <div class="row" style="margin-top: 3em;">
                    ...
                    <div class="col-md-3" style="">
                        <img src="assets/img/profile.png" class="img-thumbnail" width="400px" alt="Profile picture">
                    </div>
                </div>
                <div class="row" style="margin-top: 1em;">
                    <div class="col-sm-12" style="">
                        ...
                        <ul style="line-height:1.5;">
                            <li>[May 2026] I joined Luma AI as a Research Scientist. </li>
                            <li>[Feb. 2024] Our work on generating plausible hands in diffusion-based text-to-image models is accepted to CVPR, 2024. </li>
                            <li>[Feb. 2024] Our work on segmenting and tracking hand-held objects is accepted to CVPR, 2024. </li>                         
                            <li>[Feb. 2024] I joined Adobe Firefly as a full-time Research Scientist. </li>
